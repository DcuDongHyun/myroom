...
class PurePursuit(object):
	...
	def __init__(self):
		...
		self.scan	      = rospy.get_param("/laser_scan_topic")
		...
		self.scan_sub =  rospy.Subscriber(self.scan, LaserScan, self.scan_callback)
	...
	def scan_callback(self, scan_msg):
	    front_distances = scan_msg.ranges[0:15]
	    front_distances += scan_msg.ranges[344:354] 
